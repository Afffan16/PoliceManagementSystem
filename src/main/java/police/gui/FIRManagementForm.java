...
public class FIRManagementForm extends javax.swing.JFrame {
    ...
    private void loadFIRs() 
    {
        ...
        try 
        {
            ...
            List<FIR> firs = csvHandler.getAllFIRs();
            for (FIR fir : firs) 
            {
                tableModel.addRow(new Object[] 
                {
                    ...
                    fir.getLocation(), fir.getDescription(), fir.getCrimeType()
                });
            }
        } 
        catch (IOException e) 
    ...
    private void UpdatebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdatebtnActionPerformed
        ...
        JTextField complainantField = new JTextField((String) tableModel.getValueAt(selectedRow, 1), 20);
        JTextField fathersNameField = new JTextField((String) tableModel.getValueAt(selectedRow, 2), 20);
        JTextField contactField = new JTextField((String) tableModel.getValueAt(selectedRow, 3), 15);
        JTextField addressField = new JTextField((String) tableModel.getValueAt(selectedRow, 4), 30);
        JTextField nicField = new JTextField((String) tableModel.getValueAt(selectedRow, 5), 15);
        JTextField dateField = new JTextField((String) tableModel.getValueAt(selectedRow, 6), 10);
        JTextField timeField = new JTextField((String) tableModel.getValueAt(selectedRow, 7), 10);
        JTextField locationField = new JTextField((String) tableModel.getValueAt(selectedRow, 8), 20);
        JTextField descriptionField = new JTextField((String) tableModel.getValueAt(selectedRow, 9), 30);
        JTextField crimeTypeField = new JTextField((String) tableModel.getValueAt(selectedRow, 10), 20);

        JPanel panel = new JPanel(new GridLayout(11, 2, 10, 10));
        panel.add(new JLabel("FIR ID:"));
        panel.add(new JLabel(firId));
        panel.add(new JLabel("Complainant Name:"));
        panel.add(complainantField);
        panel.add(new JLabel("Father's Name:"));
        panel.add(fathersNameField);
        ...
        if (result == JOptionPane.OK_OPTION) 
        {
            ...
            {
                CSVHandler csvHandler = new CSVHandler();
                FIR fir = new FIR(firId, complainantField.getText(), fathersNameField.getText(),
                contactField.getText(), addressField.getText(), nicField.getText(), dateField.getText(),
                timeField.getText(), locationField.getText(), descriptionField.getText(), crimeTypeField.getText());
                csvHandler.updateFIR(fir);
                loadFIRs();
                JOptionPane.showMessageDialog(this, "FIR updated successfully!");
            } 
            catch (IOException e) 
            {
                JOptionPane.showMessageDialog(this, "Error updating FIR: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
